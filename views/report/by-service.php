...
?>
<h2 class="page-title">Ըստ ծառայությունների</h2>
    ...
    [
        ...
        'buttons' => [
            ...
            'view' => function ($url,$model) use ($date) {
                return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', ['view-service','id'=>$model['service_type_id'],'name'=>$model['name'],'date'=>$date], [
